...
const SECTIONS = [
  ...
  },
  {
    ...
    content: (
      <>
        <h3 className="terms-subheading">Types of Data Collected</h3>

        <h4 className="terms-subheading" style={{ marginTop: '1rem', fontSize: '0.95rem' }}>Personal Data</h4>
        <p>
        ...
        <h4 className="terms-subheading" style={{ marginTop: '1.5rem', fontSize: '0.95rem' }}>Usage Data</h4>
        <p>
        ...
        <h3 className="terms-subheading" style={{ marginTop: '1.75rem' }}>Tracking Technologies and Cookies</h3>
        <p>
        ...
        <ul className="legal-list">
          <li>
            ...
            all Cookies or to indicate when a Cookie is being sent. However, if You do not accept Cookies, You may not be able to use some parts of our Service. 
          ...
          <li>
            ...
            (also referred to as clear gifs, pixel tags, and single-pixel gifs) that permit the Company, for example, to count users who have visited those 
            pages or opened an email and for other related website statistics (for example, recording the popularity of a certain section and verifying system and server integrity).
          </li>
        </ul>
        <p>
          Cookies can be &ldquo;Persistent&rdquo; or &ldquo;Session&rdquo; Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, 
          while Session Cookies are deleted as soon as You close Your web browser.
        </p>
        <p>We use both Session and Persistent Cookies for the purposes set out below:</p>

        <div className="legal-callout">
          <p className="legal-callout__title">Necessary / Essential Cookies</p>
          <p><strong>Type:</strong> Session Cookies | <strong>Administered by:</strong> Us</p>
          <p style={{ marginTop: '0.35rem' }}>
            <strong>Purpose:</strong> These Cookies are essential to provide You with services available through the Website and to enable You to use some of its features. 
        ...
        <div className="legal-callout" style={{ marginTop: '1rem' }}>
          <p className="legal-callout__title">Cookies Policy / Notice Acceptance Cookies</p>
          <p><strong>Type:</strong> Persistent Cookies | <strong>Administered by:</strong> Us</p>
          <p style={{ marginTop: '0.35rem' }}>
        ...
        <div className="legal-callout" style={{ marginTop: '1rem' }}>
          <p className="legal-callout__title">Functionality Cookies</p>
          <p><strong>Type:</strong> Persistent Cookies | <strong>Administered by:</strong> Us</p>
          <p style={{ marginTop: '0.35rem' }}>
            <strong>Purpose:</strong> These Cookies allow us to remember choices You make when You use the Website, such as remembering your login details 
            or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time You use the Website.
          </p>
        </div>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <h3 className="terms-subheading" style={{ marginTop: '1.75rem' }}>Sharing Your Personal Information</h3>
    ...
    content: (
      <>
        <p>
          ...
          We will retain and use Your Personal Data to the extent necessary to comply with our legal obligations (for example, if we are required 
    ...
    content: (
      <>
        <p>
          ...
          outside of Your state, province, country or other governmental jurisdiction where the data protection laws may differ than those from Your jurisdiction.
        </p>
        <p>
  ...
  },
  {
    ...
    content: (
      <>
        <h3 className="terms-subheading">Business Transactions</h3>
        <p>
        ...
        <h3 className="terms-subheading" style={{ marginTop: '1.5rem' }}>Law Enforcement</h3>
        <p>
        ...
        <h3 className="terms-subheading" style={{ marginTop: '1.5rem' }}>Other Legal Requirements</h3>
    ...
    content: (
      <>
        <p>
          ...
          under the age of 13. If You are a parent or guardian and You are aware that Your child has provided Us with Personal Data, please contact Us. 
          If We become aware that We have collected Personal Data from anyone under the age of 13 without verification of parental consent, We take steps 
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          We will let You know via email and/or a prominent notice on Our Service, prior to the change becoming effective and update the &ldquo;Last updated&rdquo; 
  ...
  return (
    <>
      ...
      <main className="terms-main">
        ...
        <section className="terms-content-section" id="privacy-content" aria-label="Privacy policy content">
          <div className="container terms-layout">
            ...
            <aside className="terms-sidebar" aria-label="Table of contents">
              <div className="terms-sidebar__card">
                ...
                <div className="terms-sidebar__footer">
                  <p className="terms-sidebar__date">Official Policy</p>
                  <LabelSlideButton
                    label="Get in Touch"
                    link="/contact"
                    newTab={false}
            ...
            <article className="terms-articles">
              <div className="terms-header-meta">
                ...
                <span className="terms-meta-date">Amada Realty LLC</span>
              </div>
              ...
              <p style={{ marginTop: '-1.5rem', color: '#475569', lineHeight: 1.7 }}>
